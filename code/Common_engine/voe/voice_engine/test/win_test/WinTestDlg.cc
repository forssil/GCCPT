 ...
 */
//#include "voe/voice_engine/test/win_test/stdafx.h"
#include "stdafx.h"
#include <math.h>
#include "test/testsupport/fileutils.h"
#include "voe/voice_engine/test/win_test/WinTest.h"
#include "voe/voice_engine/test/win_test/WinTestDlg.h"
#include "voe/voice_engine/test/win_test/stdafx.h"
...
void CWinTestDlg::OnTimer(UINT_PTR nIDEvent)
{
    ...
    if (_delayEstimate1 && _veVideoSyncPtr)
    {
        ...
        int delayMs(0);
		int delay2(0);
        _veVideoSyncPtr->GetDelayEstimate(channel, &delayMs,&delay2);
